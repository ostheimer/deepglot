...
| 7.16 | Project-creation API must read `projectsLimit` from `BILLING_PLANS` (not a stale four-tier map); `customer.subscription.updated` must sync `Organization.plan`. Fixed 2026-05-21 (cron correctness pass). | ✅ Completed |
