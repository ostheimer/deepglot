    ...
    <div className="flex min-h-screen flex-col bg-[#fbfaf7] text-[#071521]">
      ...
      <main className="flex flex-1 items-center">
        <div className="mx-auto grid w-full max-w-[1488px] gap-10 px-5 py-20 sm:px-8 lg:grid-cols-[220px_1fr] lg:px-10 xl:px-14">
          <p className="text-[9rem] font-extrabold leading-none tracking-[-0.08em] text-[#f03b22] sm:text-[12rem]">404</p>
          <div className="max-w-2xl border-l border-[#d8d6ce] pl-8 lg:pl-12">
            <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#f03b22]">
            ...
            <Link href={getMarketingPath(locale, "home")} className="mt-8 inline-flex h-12 items-center bg-[#f03b22] px-6 font-bold text-white transition-colors hover:bg-[#d92f19]">
