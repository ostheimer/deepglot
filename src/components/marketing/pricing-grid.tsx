...
const FEATURE_ROWS: Record<SiteLocale, FeatureRow[]> = {
  en: [
    ...
    { label: "AI translation (DeepL)", values: [true, true, true, true, true, true], enterprise: true },
    ...
    { label: "OpenAI (context-aware)", values: [false, false, false, false, true, true], enterprise: true },
  ...
  de: [
    ...
    { label: "KI-Übersetzung (DeepL)", values: [true, true, true, true, true, true], enterprise: true },
    ...
    { label: "OpenAI (kontextsensitiv)", values: [false, false, false, false, true, true], enterprise: true },
    { label: "Top-Level-Domain Support", values: [false, false, false, false, false, true], enterprise: true },
    { label: "Premium Support (SLA)", values: [false, false, false, false, false, true], enterprise: true },
    { label: "SAML SSO", values: [false, false, false, false, false, false], enterprise: true },
