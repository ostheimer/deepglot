        ...
        <header className="border-b border-[#d8d6ce] bg-[#f2f0ea]">
          <div className="mx-auto max-w-5xl px-5 py-12 sm:px-8 lg:py-20">
            <Link
              ...
              className="inline-flex items-center gap-2 text-sm font-bold text-[#58636d] transition-colors hover:text-[#f03b22]"
            >
              <ArrowLeft className="h-4 w-4" weight="bold" />
              {uiText(locale, "All articles", "Alle Artikel")}
            </Link>
            <p className="mt-12 text-sm font-bold uppercase tracking-[0.18em] text-[#f03b22]">{post.copy.category}</p>
