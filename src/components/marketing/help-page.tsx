        ...
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8">
          ...
          <section id="wordpress-warmup" data-testid="help-wordpress-warmup" className="scroll-mt-8 pt-24">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-sm leading-7 text-[#58636d]">
                {de
                  ? "Melden alle versuchten Anbieter bei einem mehrteiligen Stapel nur eine Abweichung bei der Ergebnisanzahl, startet Deepglot eine begrenzte binäre Aufteilung. Der beobachtete Zwei-Text-Fall kann beide Einzeltexte erreichen; pro ursprünglichem Stapel gelten höchstens sechs Anbieteraufrufe und für alle Anbieterarbeiten zusammen höchstens 100 Sekunden. Ein weiterhin fehlerhafter Rest bleibt vorgemerkt. Fehler eines parallelen Stapels stoppen weitere rekursive Aufrufe; Zeitüberschreitungen, Authentifizierungsfehler, Ratenlimits, U+0000 und andere ungültige Antworten werden dadurch nicht zusätzlich wiederholt."
                  : "If every attempted provider reports only a count mismatch for a multi-text chunk, Deepglot starts bounded binary isolation. The observed two-text case can reach both singletons, but each original chunk allows at most six provider calls and all provider work shares a 100-second deadline. A terminal remainder stays queued. A failing parallel chunk stops further recursive calls; timeouts, authentication failures, rate limits, U+0000, and other malformed responses are not retried by this extra isolation path."}
              </p>
              <p className="mt-4 text-sm leading-7 text-[#58636d]">
                {de
