...
const COPY = {
  en: {
    ...
    providers: {
      openai: "OpenAI models. Default model is gpt-4o-mini — best $/quality ratio for translation.",
      openrouter: "OpenRouter model ids such as openai/gpt-4o-mini, google/gemini-3-pro or anthropic/claude-sonnet-4.6.",
  ...
  de: {
    ...
    providers: {
      openai: "OpenAI-Modelle. Standardmodell ist gpt-4o-mini — bestes Preis/Qualitäts-Verhältnis für Übersetzungen.",
      openrouter: "OpenRouter-Modell-IDs wie openai/gpt-4o-mini, google/gemini-3-pro oder anthropic/claude-sonnet-4.6.",
        ...
        {needsModel(selectedProvider) && (
          <div className="grid gap-2">
            ...
            <Input
              ...
              placeholder={selectedProviderOption?.recommendedModels[0] ?? "gpt-4o-mini"}
            />
