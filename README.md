...
- Successful warming stores translations locally and purges affected URLs from supported full-page caches. Hosts with `DISABLE_WP_CRON` must invoke WordPress cron themselves; unsupported page-cache plugins may require a manual purge.
