...
> ⚠️ **OUTDATED:** This section recommends DiDOM as the parser. The actual implementation uses PHP-native DOMDocument (no external dependency). The DiDOM recommendation is no longer valid.
